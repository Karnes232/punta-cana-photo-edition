...
export const Head = ({ pageContext, data }) => {
  ...
  const siteUrl = `${data.site.siteMetadata.siteUrl}${pageContext.language !== "en-US" ? `/${pageContext.language}` : ""}/weddings-punta-cana/`;
  ...
  query MyQuery($language: String!) {
    ...
    allContentfulPackages(
      ...
      nodes {
        title
        image {
          gatsbyImage(layout: CONSTRAINED, width: 500, placeholder: NONE, formats: WEBP, quality: 75)
          title
        }
        paragraph
        included
