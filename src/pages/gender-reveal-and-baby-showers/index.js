...
export const Head = ({ pageContext, data }) => {
  ...
  const siteUrl = `${data.site.siteMetadata.siteUrl}${pageContext.language !== "en-US" ? `/${pageContext.language}` : ""}/gender-reveal-and-baby-showers/`;
  ...
  query MyQuery($language: String!) {
    ...
    allContentfulPackages(
      ...
      nodes {
        ...
        image {
          title
          gatsbyImage(layout: CONSTRAINED, width: 600, placeholder: NONE, formats: WEBP, quality: 75)
        }
        packagePage {
          urlSlug
        }
