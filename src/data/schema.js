export const schema = {
  ...
  name: "Sertuin Events",
  description:
    "A full-service event planning company for romantic celebrations, private events, weddings and corporate productions in Punta Cana.",
  ...
  sameAs: ["https://sertuinevents.com/"],
};
