...
export const buildProposalPackageFaqs = ({ language, details }) => {
  ...
  const dinnerAnswer = details?.dinnerIncluded
    ? isPortuguese
      ? "O jantar de três tempos para dois já está incluído. Cada pessoa escolhe uma entrada, um prato principal e uma sobremesa. A escolha pode ser alterada até 48 horas antes."
      : isFrench
        ? "Le dîner en trois services pour deux est déjà inclus. Chaque personne choisit une entrée, un plat et un dessert. Les choix peuvent être modifiés jusqu’à 48 heures avant l’expérience."
        : isSpanish
    ...
    : isPortuguese
      ? "O jantar de três tempos para dois pode ser adicionado por US$ 299. Cada pessoa escolhe entrada, prato principal e sobremesa; as escolhas podem ser alteradas até 48 horas antes. A experiência continua limitada a duas horas."
      : isFrench
        ? "Le dîner en trois services pour deux peut être ajouté pour 299 USD. Chaque personne choisit une entrée, un plat et un dessert ; les choix peuvent être modifiés jusqu’à 48 heures avant. L’expérience complète reste limitée à deux heures."
        : isSpanish
  ...
  const items = isPortuguese
    ? [
        [
          ...
          "O casal permanece entre 90 minutos e no máximo duas horas na praia. O transporte não conta nesse período. O atraso do casal é descontado do tempo; o motorista espera no máximo 30 minutos.",
        ],
        [
          "Quais áreas têm transporte incluído?",
          "O transporte privativo do casal está incluído desde hotel, Airbnb ou villa em Cap Cana, Punta Cana Resort, El Cortecito, Bávaro, Verón, Macao e Uvero Alto. Miches pode ter custo adicional. Cada acompanhante paga US$ 20, até a capacidade de 10 pessoas.",
        ],
        [
          "Quantas fotografias receberemos?",
          "São garantidas mais de 70 fotografias JPG em alta resolução, corrigidas profissionalmente e entregues em até 48 horas por link permanente do Google Drive. Arquivos RAW são gratuitos sob solicitação.",
        ],
        [
          "O vídeo do pedido está incluído?",
          "Sim. Um vídeo vertical de 3 a 5 minutos pelo celular registra revelação, aliança e celebração. Vídeo profissional com drone é um adicional de US$ 399.",
        ],
        [
          "Como reservar e quando pagar o saldo?",
          "A data é reservada após a assinatura e o depósito de US$ 200, integralmente descontado do preço. O saldo é pago ao fim da experiência, antes do retorno.",
        ],
        [
          "Quais taxas se aplicam ao pagamento eletrônico?",
          "O saldo eletrônico acrescenta 18% de ITBIS e 10% de processamento, calculados apenas sobre o saldo. O depósito não tem essas taxas. Em dinheiro, aceitamos USD, DOP e GBP.",
        ],
        [
          "O depósito é reembolsável e posso mudar a data?",
          "O depósito não é reembolsável quando o cliente cancela, mas pode ser transferido para outra data disponível. Se a empresa cancelar, devolve todo o valor pago em até uma semana.",
        ],
        [
          "O que acontece se chover?",
          "Monitoramos o clima. Um gazebo coberto pode ser usado sem custo com a mesma decoração ou outra data pode ser combinada. Se não for seguro continuar, oferecemos sessão romântica de uma hora no dia seguinte com fotógrafo e transporte.",
        ],
        [
          "A praia é totalmente privativa e tem banheiro?",
          "A montagem é reservada ao casal em uma praia de baixo movimento em Uvero Alto. Os primeiros 60 metros do litoral são públicos por lei. Há banheiro próximo com água, pia, vaso sanitário, espelho e espaço para troca.",
        ],
        [
          "As flores e cores podem ser personalizadas?",
          "O pacote preserva a paleta e o volume descritos. Mudanças de cor recebem cotação. O buquê incluído usa flores naturais sazonais; flores específicas são cotadas separadamente.",
        ],
        ["Como funciona o jantar?", dinnerAnswer],
      ]
    : isFrench
      ? [
          [
            "Combien de temps dure l’expérience ?",
            "Le couple passe entre 90 minutes et deux heures au maximum sur la plage. Le transport n’est pas inclus dans cette durée. Tout retard du couple est déduit du temps sur place ; le chauffeur attend au maximum 30 minutes.",
          ],
          [
            "Quelles zones bénéficient du transport inclus ?",
            "Le transport privé du couple est inclus depuis tout hôtel, Airbnb ou villa de Cap Cana, Punta Cana Resort, El Cortecito, Bávaro, Verón, Macao et Uvero Alto. Miches peut entraîner un supplément. Chaque accompagnant paie 20 USD, dans la limite de 10 personnes.",
          ],
          [
            "Combien de photos recevrons-nous ?",
            "Plus de 70 photos JPG haute résolution, corrigées professionnellement, sont garanties et livrées sous 48 heures par lien Google Drive permanent. Les fichiers RAW sont gratuits sur demande.",
          ],
          [
            "La vidéo de la demande est-elle incluse ?",
            "Oui. Une vidéo verticale de 3 à 5 minutes au téléphone enregistre la révélation, la bague et la célébration. Une vidéo professionnelle avec drone est disponible en option pour 399 USD.",
          ],
          [
            "Comment réserver et quand régler le solde ?",
            "La date est réservée après signature du contrat et versement d’un acompte de 200 USD, entièrement déduit du prix. Le solde est réglé à la fin de l’expérience, avant le trajet retour.",
          ],
          [
            "Quels frais s’appliquent à un paiement électronique ?",
            "Le paiement électronique du solde ajoute 18 % d’ITBIS et 10 % de frais de traitement, calculés uniquement sur le solde. L’acompte ne supporte pas ces frais. Les paiements en espèces sont acceptés en USD, DOP et GBP.",
          ],
          [
            "L’acompte est-il remboursable et puis-je changer la date ?",
            "L’acompte n’est pas remboursable si le client annule, mais il peut être transféré vers une autre date disponible. Si l’entreprise annule, elle rembourse tout montant payé sous une semaine.",
          ],
          [
            "Que se passe-t-il s’il pleut ?",
            "Nous surveillons la météo. Un gazebo couvert peut être utilisé sans supplément avec la même décoration, ou une autre date peut être convenue. S’il devient dangereux de poursuivre, une séance romantique d’une heure avec photographe et transport est proposée le lendemain.",
          ],
          [
            "La plage est-elle entièrement privée et y a-t-il des toilettes ?",
            "L’installation est réservée au couple sur une plage très peu fréquentée d’Uvero Alto. Les 60 premiers mètres du littoral sont publics selon la loi. Des toilettes proches disposent d’eau, lavabo, WC, miroir et espace pour se changer.",
          ],
          [
            "Les fleurs et les couleurs peuvent-elles être personnalisées ?",
            "Le forfait conserve la palette et le volume décrits. Les changements de couleur font l’objet d’un devis. Le bouquet inclus utilise des fleurs naturelles de saison ; des fleurs précises sont chiffrées séparément.",
          ],
          ["Comment fonctionne le dîner ?", dinnerAnswer],
        ]
      : isSpanish
        ? [
            [
